    ...
    return (
      <div className="mt-10 flex flex-col">
        ...
        <thead className="bg-gray-50">
          <tr>
            <th scope="col" className="tableHeader">First name</th>
            <th scope="col" className="tableHeader">Last name</th>
            ...
            return (
              <tr key={user._id}>
                ...
                <td className="tableTD">
                  <Link href={`${user._id}/edit`} className="text-indigo-600 hover:text-indigo-900">Edit</Link>
                </td>
                <td className="tableTD">
                  <a
